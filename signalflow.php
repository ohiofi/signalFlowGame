...
mysql_select_db($database_ohiofi, $ohiofi);
$query_rsUser=sprintf("SELECT users.userID, users.game2 FROM users WHERE userName=%s ",
  GetSQLValueString($colname_rsGame3, "text")); 
    ...
    <span id="blank"></span>
            <br />
                ...
                <div id="tryAgain" class="popup">
                    <h2>Incorrect</h2>
                  <form id="form2" name="form2" action="<?php echo $editFormAction; ?>" method="POST"><input name="entryNumber" type="hidden" value="" /><input name="userName" type="hidden" value="" /><input type="hidden" name="question2" id="question2" value=""><input type="hidden" name="response2" id="response2" value=""><input name="tally" type="hidden" value="0" /><input name="questionNumber" type="hidden" value="<?php echo $currentQuestion; ?>" /><input name="userNumber" type="hidden" value="<?=$row_rsUser["userID"] ?>" /><input name="game2total" type="hidden" value="<?php echo $totalRows_rsScore3; ?>" /><input class="submit button popupbutton" type="submit" name="Submit" id="Submit" value="Continue">
                ...
                <? if ($currentQuestion % 1 == 0) { ?>
                	...
                	<h2>Your current score is<br /><? echo $row_rsUser["game2"] ?> <? if ($row_rsUser["game2"] != 1)
                                echo " pts";
                            else
                                echo " pt";
                            ?></h2>
